...
public class SpecialProductBlackMarketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_black_market);

        myToolBar = (Toolbar) findViewById(R.id.blackMarket_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.p_black_market);
        getSupportActionBar().setTitle("Black Market Packages");

        onlineReference = FirebaseDatabase.getInstance().getReference().child("OnlineUser");
        onlineReference.keepSynced(true);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Black Market Packages");
        ...
        recyclerView = (RecyclerView) findViewById(R.id.blackMarket_recycler);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SpecialProductBlackMarketActivity.this, err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

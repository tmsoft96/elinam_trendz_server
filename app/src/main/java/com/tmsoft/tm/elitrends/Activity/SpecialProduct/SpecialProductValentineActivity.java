...
public class SpecialProductValentineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_valentine);

        myToolBar = (Toolbar) findViewById(R.id.valentine_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.p_valentine);
        getSupportActionBar().setTitle("Valentine Packages");

        onlineReference = FirebaseDatabase.getInstance().getReference().child("OnlineUser");
        onlineReference.keepSynced(true);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Valentine Packages");
        ...
        recyclerView = (RecyclerView) findViewById(R.id.valentine_recycler);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SpecialProductValentineActivity.this, err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

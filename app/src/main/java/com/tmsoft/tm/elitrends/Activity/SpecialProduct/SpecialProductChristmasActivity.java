...
public class SpecialProductChristmasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_christmas);

        myToolBar = (Toolbar) findViewById(R.id.christmas_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.p_christmas);
        getSupportActionBar().setTitle("Christmas Packages");

        onlineReference = FirebaseDatabase.getInstance().getReference().child("OnlineUser");
        onlineReference.keepSynced(true);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Christmas Packages");
        ...
        recyclerView = (RecyclerView) findViewById(R.id.christmas_recycler);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SpecialProductChristmasActivity.this, err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

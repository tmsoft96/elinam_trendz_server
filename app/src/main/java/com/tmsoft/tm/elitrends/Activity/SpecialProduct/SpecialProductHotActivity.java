...
public class SpecialProductHotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_hot);

        myToolBar = (Toolbar) findViewById(R.id.hot_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.p_hot);
        getSupportActionBar().setTitle("Hot Packages");

        onlineReference = FirebaseDatabase.getInstance().getReference().child("OnlineUser");
        onlineReference.keepSynced(true);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Hot Packages");
        ...
        recyclerView = (RecyclerView) findViewById(R.id.hot_recycler);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SpecialProductHotActivity.this, err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

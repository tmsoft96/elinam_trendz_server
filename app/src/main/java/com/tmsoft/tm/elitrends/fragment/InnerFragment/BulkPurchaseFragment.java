...
public class BulkPurchaseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refresh = (SwipeRefreshLayout) view.findViewById(R.id.fragmentOrderOfMe_refresh);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    allProductsAdapter = new AllProductsAdapter(allProductsClassList, view.getContext(), noColums.getLayoutWidth(), noColums.getTestLength());

...
public class SpecialProductEasterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_easter);

        myToolBar = (Toolbar) findViewById(R.id.easter_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.p_easter);
        getSupportActionBar().setTitle("Easter Packages");

        onlineReference = FirebaseDatabase.getInstance().getReference().child("OnlineUser");
        onlineReference.keepSynced(true);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Easter Packages");
        ...
        recyclerView = (RecyclerView) findViewById(R.id.easter_recycler);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SpecialProductEasterActivity.this, err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
